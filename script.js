...
var filterResult = inventors.filter(inventor => `${inventor.year}` < 1600 && `${inventor.year}` >= 1500);
console.table(filterResult);

// Array.prototype.map()
// 2. Give us an array of the inventors' first and last names
var mapResult = inventors.map(inventor => `${inventor.first} ${inventor.last}`);
console.log(mapResult);

// Array.prototype.sort()
// 3. Sort the inventors by birthdate, oldest to youngest
var sortResult = inventors.sort(function(a, b) {
...
var oldest = inventors.sort(function(a, b){
  var old = a.passed - a.year;
  var young = b.passed - b.year;
...
// const links = Array.from(category.querySelectorAll('a')); //turns nodelist into array to map
// const de = links
